...
namespace RO.DevTest.Persistence.Migrations
{
    ...
    [Migration("20250422175939_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RO.DevTest.Domain.Entities.Product", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                        .HasDefaultValueSql("guid_generate_v4()");
            ...
            modelBuilder.Entity("RO.DevTest.Domain.Entities.ReducedEntities.RProduct", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("RO.DevTest.Domain.Entities.ReducedEntities.RUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("RO.DevTest.Domain.Entities.Sale", b =>
                {
                    ...
                    b.HasOne("RO.DevTest.Domain.Entities.ReducedEntities.RUser", "Customer")
                        .WithMany()
